// MixedFractionTests+LosslessStringConvertibleTests.swift
// RationalsTests
//
...
extension MixedFractionTests {
	func test_initializedWithStringFails() {
		// Given
		let strings: Set<String> = ["1 1 / 2", "1 1÷2", "1.0 1.0/2.0"]
	...
	func test_initializedWithStringSucceeds() {
		// Given
		let strings: Set<String> = ["-1", "-0.5", "-1 1/2", "1 -1/2", "1 1/-2", "0.5", "1"]
